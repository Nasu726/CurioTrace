...
// Popup/onboarding-side SessionStartPort. The permission controller calls this
// only after the browser host permission has been verified. The background
// broker rechecks permission before forwarding to the native helper.
